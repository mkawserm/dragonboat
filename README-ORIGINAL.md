...
To use Dragonboat, make sure to import the package __github.com/mkawserm/dragonboat/v3__. Also add "github.com/mkawserm/dragonboat/v3 v3.2.0" to the __require__ section of your project's go.mod file.
